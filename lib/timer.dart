...
import'package:percent_indicator/circular_percent_indcicator.dart';


class Activitytimer extends StatelessWidget {
  final String image =""D:\Downloads\sports.jpg""
      final String tag = 'imageHeader';

  Widget build(BuildContext context){
    return Scaffold(
      body: singlechildscrollview(
        child: orientationbuilder(builder:context,orienatation){
          return(debugCheckHasMediaQuery(context).orientation==
